...
namespace MemesFinderMessageOrchestrator.Clients
{
    ...
    public class SendKeywordMessageToServiceBus : AbstractSendMessagesToServiceBus
    {
        ...
        private readonly string _topic = "keywordmessages";

        public SendKeywordMessageToServiceBus(ILogger<MessageOrchestrator> log, IServiceBusClient serviceBusClient)
        {
            _logger = log;
