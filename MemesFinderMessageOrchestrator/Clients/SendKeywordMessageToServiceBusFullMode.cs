...
{
    //send an object to the server in KeywordMessagesTopic if it contains a key word. Always uses AI analysis
    public class SendKeywordMessageToServiceBusFullMode : AbstractSendMessagesToServiceBus
    {
        ...
        public SendKeywordMessageToServiceBusFullMode(ILogger<MessageOrchestrator> log,
        ...
        {
            return mode == AnalysisMode.FULL_MODE;
        }
    }
}