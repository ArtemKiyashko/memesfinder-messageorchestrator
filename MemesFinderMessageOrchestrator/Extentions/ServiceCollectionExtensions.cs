...
namespace MemesFinderMessageOrchestrator.Extentions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddConversationAnalyticsClient(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<ISendMessageToServiceBus, SendKeywordMessageToServiceBusFullMode>();
            services.AddTransient<ISendMessageToServiceBus, SendKeywordMessageToServiceBusSemiMode>();
            services.AddTransient<ISendMessageToServiceBus, SendKeywordMessageToServiceBusRegexMode>();
