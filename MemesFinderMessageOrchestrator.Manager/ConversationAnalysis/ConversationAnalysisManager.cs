...
using static MemesFinderMessagesOrchestrator.Models.ResponceConversationAnalysisClientModel;

namespace MemesFinderMessageOrchestrator.Manager.ConversationAnalysis
{
    public class ConversationAnalysisManager : IConversationAnalysisManager
    {
        ...
        public ConversationAnalysisManager(ILogger<MessageOrchestrator> log, IOptions<MessageAnalysisClientOptions> messageAnalysisClientOptions)
        {
